#ifndef DEEPG_ROTATION_3D_H
#define DEEPG_ROTATION_3D_H

#include "transforms/transformation_3d.h"

class RotationTransformation3D : public SpatialTransformation3D {
public:
  explicit RotationTransformation3D(const HyperBox &domain)
