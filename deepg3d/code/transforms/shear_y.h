#ifndef DEEPG_SHEAR_Y_H
#define DEEPG_SHEAR_Y_H

#include "transforms/transformation_3d.h"

class ShearYTransformation3D : public SpatialTransformation3D {
public:
  explicit ShearYTransformation3D(const HyperBox &domain)
