#ifndef DEEPG_ROTATION_Z_H
#define DEEPG_ROTATION_Z_H

#include "transforms/transformation_3d.h"

class RotationZTransformation3D : public SpatialTransformation3D {
public:
  explicit RotationZTransformation3D(const HyperBox &domain)
