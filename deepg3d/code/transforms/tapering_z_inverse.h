#ifndef DEEPG_TAPERING_Z_INVERSE_H
#define DEEPG_TAPERING_Z_INVERSE_H

#include "transforms/transformation_3d.h"

class TaperingZInverseTransformation3D : public SpatialTransformation3D {
public:
  explicit TaperingZInverseTransformation3D(const HyperBox &domain)
...
#endif // DEEPG_TAPERING_Z_INVERSE_H
