#ifndef DEEPG_ROTATION_X_H
#define DEEPG_ROTATION_X_H

#include "transforms/transformation_3d.h"

class RotationXTransformation3D : public SpatialTransformation3D {
public:
  explicit RotationXTransformation3D(const HyperBox &domain)
